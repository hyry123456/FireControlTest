...
namespace Common
{
    public class CommonFunction : MonoBehaviour
    {
        ...
        private IEnumerator FindObject(string name, Transform addordTransform, Handler.HandlerList.ISetOneParam<Transform> setOneParam)
        {
        ...
        public static void DelayFindInTransform(string name,Transform according, 
            Handler.HandlerList.ISetOneParam<Transform> setOne)
        {
